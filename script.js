...
const firebaseConfig = {
  apiKey: "AIzaSyDX633NoJX6oPdKnEue-53Uxn5EmkvAWJ4",
  authDomain: "emotion-wheel-ba5e1.firebaseapp.com",
  projectId: "emotion-wheel-ba5e1",
  storageBucket: "emotion-wheel-ba5e1.appspot.com",
  messagingSenderId: "66345696406",
  appId: "1:66345696406:web:fffe49a6f3c0fe91a1d6b7",
  measurementId: "G-TWMLJ4FQ75",
};
...
const messageBox = document.getElementById("messageQ");
const messagePara = messageBox.querySelector("#word-def");
const submitBtn = document.getElementById("btn_sub");
const messageTxt = document.querySelector("#definition");
...
const createTextBox = (el) => {
  const textBox = document.createElement("text");
  textBox.insertAdjacentText("afterbegin", el);
  return textBox;
};

const createDivSpan = () => {
  const divTwo = document.createElement("div");
  divTwo.setAttribute("id", "line-wrap");
  for (let i = 0; i < 4; i++) {
    const spans = document.createElement("span");
    divTwo.insertAdjacentElement("beforeend", spans);
  }
  return divTwo;
};

const createSpanPreview = (el) => {
  const spanPreview = document.createElement("span");
  spanPreview.classList.add("primary-emotion-preview");
  spanPreview.style.content = `url(././images/${el}.svg)`;
  return spanPreview;
};

const createParagraph = (el) => {
  const paragraph = document.createElement("p");
  paragraph.classList.add("preview-text");
  paragraph.insertAdjacentText("afterbegin", el);
  return paragraph;
};
...
const createOuterDiv = (date, previewText, primaryEmotion) => {
  ...
  divOne.insertAdjacentElement("beforeend", createDivSpan());
  divOne.insertAdjacentElement("afterbegin", createTextBox(`${date}`));
  divOne.insertAdjacentElement(
    "beforeend",
    createSpanPreview(`${primaryEmotion}`)
  );
  divOne.insertAdjacentElement("beforeend", createParagraph(`${previewText}`));
  ...
  [
    {
      ...
      quote: "We learn humility through accepting humiliations cheerfully.",
    ...
    },
    {
      ...
      quote: "Our thoughts are not our own - when in a submissive state.",
      author: "Monaristw",
    },
    {
      word: "insecure",
    ...
    },
    {
      ...
      quote: "When you're scared, you stay as you are!",
  ...
  [
    {
      word: "ridiculed",
      definition:
        "subjected (someone or something) to contemptuous and dismissive language or behavior.",
      quote: "Fear of ridicule begets the worst cowardice.",
      author: "André Gide",
    },
    {
      word: "disrespected",
    ...
    },
    {
      ...
      author: "Grandalf the purple",
    },
    {
      word: "inferior",
      definition:
        "the quality or state of feeling less important, valuable, or worthy.",
      quote: "Remember no on can make you feel inferior without your consent.",
    ...
    },
    {
      word: "overwhelmed",
      definition:
        "to be pushed past your capacity, or have too many things to deal with.",
      quote:
    ...
    {
      word: "frightened",
      definition: "to suddenly feel afraid, anxious.",
      quote:
    ...
    {
      word: "terrified",
      definition: "to feel extreme fear.",
...
let anger = new PrimaryEmotion(
  ...
  [
    ...
    {
      word: "threatened",
      definition: "to show an intention to do harm or something unwanted.",
      quote:
    ...
    {
      word: "hateful",
      definition: "filled with or causing strong dislike.",
      quote: "When we hate other people, it reduces ourselves.",
    ...
    },
    {
      ...
      quote:
        "You wanna argyuh, I can't argyuh with you. You mad. You big mad. I'm happy. leave me alone.",
      author: "Algernod L. Washington",
    },
    {
      word: "aggressive",
      definition:
    ...
    },
    {
      word: "frustrated",
      definition:
        "One of the greatest sources of insecurity and frustration is our tendency to try and change things that we don't have any control of.",
      quote: "The feeling of frustration forces some to seek inspiration.",
      author: "Ryan Help",
    },
    {
      word: "distant",
      definition: "not intimate; cold or reserved.",
      quote:
    ...
    {
      word: "critical",
      definition: "likely or eager to find fault.",
      quote:
  ...
  [
    ...
    },
    {
      word: "jealous",
      definition:
        "feeling or showing an unhappy or angry desire to have what someone else.",
      quote:
    ...
    {
      word: "violated",
      definition: "failing to respect (someone's peace, privacy, or rights).",
      quote:
    ...
    {
      word: "furious",
      definition: "full of anger or energy; violent or intense.",
      quote: "To be angry is to let others' mistakes punish yourself.",
      author: "Buddha",
    },
    {
      word: "enraged",
      definition: "intense and sudden anger.",
      quote:
    ...
    },
    {
      ...
      quote: "Healthy scepticism is the basis of all accurate observation.",
...
let disgust = new PrimaryEmotion(
  "disgust",
  [
    {
      word: "disapproval",
    ...
    },
    {
      word: "avoidant",
      definition:
        "attempting to avoid thoughts, feelings, memories, physical sensations, and other internal struggles.",
      quote:
  ...
  [
    {
      ...
      quote:
        "Make today Judgment Free in words, and, most important, in thought. Let's work on altering the way we think...",
      author: "Orly Wahba",
    },
    {
      word: "loathing",
...
let sad = new PrimaryEmotion(
  ...
  [
    ...
    },
    {
      word: "abandoned",
      definition:
        "to have been given up on or discontinued any further interest in something because of discouragement, weariness, distaste, or the like.",
      quote:
        "You have not been abandoned. You are never alone, except by your own choice.",
      author: "Jonathan L. Huie",
    },
    {
      word: "despair",
  ...
  [
    ...
    {
      word: "victimized",
      definition: "to be treated cruelly or unfairly.",
      quote:
    ...
    {
      word: "inferior",
      definition: "to feel lower than another in rank, status, or ability.",
      quote:
    ...
    },
    {
      ...
      quote: "None are so empty as those who are full of themselves.",
      author: "Bernard Williams",
    },
    {
      word: "unwanted",
      definition: "not or no longer desired.",
      quote:
    ...
    },
    {
      word: "isolated",
      definition:
        "far away and difficult to get to; happening only once; feeling alone and unhappy, with no support.",
      quote: "Isolation has carved me in its image and likeness.",
...
let happy = new PrimaryEmotion(
  "happy",
  [
    {
      word: "optimistic",
      definition: "expecting good things to happen : hopeful.",
      quote:
    ...
    },
    {
      word: "powerful",
      definition:
        "having the ability to control or influence people or things · having a strong effect on someone or something.",
      quote:
    ...
    {
      word: "accepted",
      definition: "regarded favorably : given approval or acceptance.",
      quote:
  ...
  [
    ...
    ,
    {
      word: "open",
      definition:
        "To be receptive to or welcoming of something that comes from outside of oneself.",
      quote:
    ...
    {
      word: "playful",
      definition: "wanting to have fun and not take things too seriously.",
      quote:
    ...
    },
    {
      word: "hopeful",
      definition:
        "believing or causing you to believe that something desired will happen.",
      quote:
    ...
    {
      word: "provocative",
      definition: "arousing desire or interest, especially deliberately.",
      quote:
    ...
    },
    {
      word: "fulfilled",
      definition:
        "To bring into actuality; effect or make real. To feel whole.",
      quote:
    ...
    {
      word: "important",
      definition: "feeling of much or great significance or consequence.",
      quote: "Significance is about who we are before it is about what we do.",
      author: "John Ortberg",
    },
    {
      word: "inquisitive",
      definition: " wanting to discover as much as you can about things.",
      quote:
    ...
    {
      word: "amused",
      definition: "pleasantly entertained or diverted (as by something funny).",
      quote:
    ...
    },
    {
      ...
      quote: "I'm in favor of animal liberation. Why? Because I'm an animal.",
      author: "Edward Abbey",
    },
  ]
);

let surprise = new PrimaryEmotion(
  "surprise",
  [
    {
      word: "excited",
    ...
    {
      word: "amazed",
      definition: "greatly surprised; astounded; suddenly filled with wonder.",
      quote: "Be infinitely flexible and constantly amazed.",
      author: "Jason Kravits",
    },
    {
      word: "confused",
    ...
    {
      word: "startled",
      definition: "disturbed or agitated suddenly, as by surprise or alarm.",
      quote:
  ...
  [
    ...
    },
    {
      ...
      quote: "I shall continue to explore-the astonishment of living.",
      author: "Enid Bagnold",
    },
    {
      word: "perplexed",
      definition:
        "to feel confused and slightly worried by something because you do not understand it.",
      quote:
...
let emotionCollection = [fear, anger, disgust, sad, happy, surprise];

console.log(emotionCollection);

let radioArray = document.getElementsByClassName("primaryRadio");

// Type Writer Functions

var quoteArray = [
  `Welcome! This little app was created to help practice bringing clarity to our emotions using an awesome little tool known as the emotion wheel. We can do this through understanding our emotions with a more precise definition of what we’re actually feeling. That precision is what helps bring language to our pain and pleasures so we can clearly recognize how our emotions play a role in our everyday lives. (Erase this text to get started, or click the question mark for instructions!)`,
];
var textPosition = 0;
// speed in milliseconds
var speed = 60;
const typewriter = () => {
  txtArea.innerText = quoteArray[0].substring(0, textPosition);

  if (textPosition++ != quoteArray[0].length) setTimeout(typewriter, speed);
};

const secondaryWrap = document.getElementById("secondary_wrap");
const tertiaryWrap = document.getElementById("tertiary_wrap");

const secondaryEmote = (e, def, quote, author) => {
  let span = document.createElement("span");
  span.className = "secondary_span";
  span.classList.add("fade-in-left");
  span.innerHTML = `${e}`;
  secondaryWrap.appendChild(span);
  span.addEventListener("click", () => {
    messagePara.innerHTML = span.innerText + ":";
    messageTxt.innerHTML = ` ${def}`;
    quoteTxt.innerHTML = `"${quote}" <br /> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; -${author}`;
  });
  return span;
};

const tertiaryEmote = (e, def, quote, author) => {
  let span = document.createElement("span");
  span.className = "tertiary_span";
  span.classList.add("fade-in-left");
  span.innerHTML = `${e}`;
  tertiaryWrap.appendChild(span);
  span.addEventListener("click", () => {
    messagePara.innerHTML = span.innerText + ":";
    messageTxt.innerHTML = ` ${def}`;
    quoteTxt.innerHTML = `"${quote}" <br /> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; -${author}`;
...
const emoteArrayData = [];
const emoteLastIndex = emoteArrayData[emoteArrayData.length - 1];
...
const retrieveTime = () => {
  ...
  let getTimeStamp = new Date().toLocaleTimeString("en-US", {
    hour12: true,
    hour: "numeric",
    minute: "numeric",
  });

  let dateObj = new Date().toLocaleString("en-US", options);

  let currentDate = `${dateObj} ${getTimeStamp}`;

  currentTimeStamp = currentDate;
};

const getLastEmotion = (el) => {
  // let lastindex = el[el.length - 1];
  return el;
};
...
const uploadData = () => {
  if (emoteArrayData.length === 0) {
    alert("Please select a primary emotion before submitting, thank you!");
  } else {
    retrieveTime();
...
submitBtn.addEventListener("click", () => {
  if (txtArea.innerHTML.length < 300) {
    ...
    console.log("this shit hit twice");
  }
});
  ...
  setTimeout(() => {
    ...
    txtArea.addEventListener("keydown", (e) => {
      if (e.code === "Enter" && typing === false) {
        ...
        console.log("working on layer 4");
      }
    });
  }, 32800);
};
...
const addClick = (arr) => {
  Array.from(arr).forEach((e) => {
    let elemSibling = e.nextElementSibling;
    let elemSibText = elemSibling.innerHTML;
    e.addEventListener("click", () => {
      elemSibling.classList.toggle("testToggle");

      for (let i = 0; i < arr.length; i++) {
        let tempSibling = arr[i].nextElementSibling;
        let tempSiblingText = tempSibling.innerHTML;
        if (elemSibText !== tempSiblingText) {
          tempSibling.classList.remove("testToggle");
        } else {
          tempSibling.classList.add("testToggle");
        }
      }

      for (let j = 0; j < emotionCollection.length; j++) {
        if (elemSibText == emotionCollection[j].primary) {
          if (secondaryWrap.innerText.length <= 0) {
            emotionCollection[j].secondary.forEach((e) => {
              secondaryEmote(e.word, e.definition, e.quote, e.author);
            });
            emotionCollection[j].tertiary.forEach((e) => {
              tertiaryEmote(e.word, e.definition, e.quote, e.author);
            });
          } else if (secondaryWrap.innerText.length > 0) {
            secondaryWrap.innerHTML = "";
            tertiaryWrap.innerHTML = "";
            emotionCollection[j].secondary.forEach((e) => {
              secondaryEmote(e.word, e.definition, e.quote, e.author);
            });
            emotionCollection[j].tertiary.forEach((e) => {
      ...
      emoteArrayData.push(elemSibText);
      getLastEmotion(emoteArrayData);
    });
  });
};
...
const init = () => {
  ...
  // Modal Variables
  const exitBtn = document.querySelector(".fa-times-circle");
...
// test function to create span element
